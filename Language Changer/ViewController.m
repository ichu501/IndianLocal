...
//    [self.flagImageView setImage:flagImage];
    ...
    NSString *lang = [[[LanguageManager sharedLanguageManager] getSelectedLocale] languageCode];
    ...
    if ([lang isEqualToString:@"ml"]) {
//        self.textView.font = [UIFont fontWithName:@"MalayalamSangamMN" size:18];
        [self.textView setFont:[UIFont fontWithName:@"MalayalamSangamMN" size:18]];
    }
    self.textView.contentOffset = CGPointZero;
